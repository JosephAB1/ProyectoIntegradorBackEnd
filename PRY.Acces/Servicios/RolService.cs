...
namespace PRY.DataAcces.Servicios
{
    public class RolService : IRolService
    {
        ...
        public async Task<BaseResponse<int>> Edit(Rol rol)
        {
            ...
            try
            {
                using (var conexion = _context.ObtenerConneccion())
                {
                    ...
                    response.Data = await conexion.ExecuteScalarAsync<int>(RolCommands.EDIT, rol, commandType: CommandType.StoredProcedure);
                    response.IsSucces = true;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BaseResponse<int>> Save(Rol rol)
        {
            var response = new BaseResponse<int>();
            try
            {
                using (var conexion = _context.ObtenerConneccion())
                {
                    ...
                    response.Data = await conexion.ExecuteScalarAsync<int>(RolCommands.INSERT, rol, commandType: CommandType.StoredProcedure);
                    response.IsSucces = true;
                }
            }
            catch (Exception ex)
